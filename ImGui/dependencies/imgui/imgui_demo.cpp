...
//K vars
     auto orangeColor  = ImVec4(1.0f, 0.65f, 0.0f, 1.0f);
     auto redColor  = ImVec4(1.0f, 0.0f, 0.0f, 1.0f);
...
void ImGui::ShowDemoWindow(bool* p_open) {
    ...
    //ImGui::GetIO().FontGlobalScale = 1.5f; //! Adjust the scale factor as needed
    ...
    //    // General Tab
    //    if (ImGui::BeginTabItem("Main Features")) {
    ...
    //        ImGui::Checkbox("Auto Pick Up Weapon", &Menu::modSettings.isAutoPickUpWeapon);  
    //     
    //       /* ImGui::EndTabItem();     */  
    ...
    //        ImGui::NewLine(); // Move to the next line
    //        // Fast Forward Key Binding
    //        //float lineStartPosY = ImGui::GetCursorPosY();



    //        ImGui::Text("Fast Forward Key:\t");
    //        if (!isWaitingForFastForwardKeyPress) {           
    //            std::string fastForwardKeyName = Menu::keyCodeToString(Menu::modSettings.fastForwardKeyVkCode);
    //            ImGui::SameLine();
    ...
    //        }
    //        ImGui::SameLine();
    //        //float buttonPosY = lineStartPosY + (ImGui::GetTextLineHeight() - ImGui::GetFrameHeight()) / 2;
    //        //ImGui::SetCursorPosY(buttonPosY);
    //        //? Imgui need different name for each btn otherwise it will create confusion as it think they're all the same if they have the same name. This caused me a lot of frustration...
    ...
    //        //ImGui::SetCursorPosY(lineStartPosY); // Reset Y position for the next line
    //        if (isWaitingForFastForwardKeyPress &&  Menu::lastKeyPressed != -1) {
    //            Menu::modSettings.fastForwardKeyVkCode = Menu::lastKeyPressed;
    //            //ModSettings::assignFastForwardKeyCode(ImGuiManager::lastKeyPressed);
    ...
    //        ImGui::NewLine(); // spacing
    //        ImGui::NewLine(); // spacing
    //        //lineStartPosY = ImGui::GetCursorPosY();


    //        ImGui::Text("Normal Speed Key:\t");
    //        if (!isWaitingForNormalSpeedKeyPress) {
    //            //int normalSpeedKeyVkCode = ModSettings::normalSpeedKeyVkCode.load();
    //            std::string normalSpeedKeyName = Menu::keyCodeToString(Menu::modSettings.normalSpeedKeyVkCode);
    //            ImGui::SameLine();
    //            if (Menu::isDuplicateKeyError()) {
    //                 ImGui::PushStyleColor(ImGuiCol_Text, redColor);
    ...
    //        }
    //        ImGui::SameLine();
    //        //buttonPosY = lineStartPosY + (ImGui::GetTextLineHeight() - ImGui::GetFrameHeight()) / 2;
    //        //ImGui::SetCursorPosY(buttonPosY);
    ...
    //            //ModSettings::normalSpeedKeyVkCode.store(ModSettings::lastKeyPressed);
    //            isWaitingForNormalSpeedKeyPress = false;
    //            Menu::lastKeyPressed = -1;// Reset for the next capture
    //        }  


    //        ImGui::NewLine(); // spacing
    //        ImGui::Text("Will require save or checkpoint reload if this is changed while playing");
    //        ImGui::Checkbox("Disable Items Highlighting", &Menu::modSettings.isDisableItemHighlighthing);


    //        ImGui::EndTabItem(); //! end main features
    //    }
    ...
    //            std::string flashLightKeyName = Menu::keyCodeToString(Menu::modSettings.flashLightKeyVkCode);
    //            ImGui::SameLine();
    //            if (Menu::isDuplicateKeyError()) {
    //                 ImGui::PushStyleColor(ImGuiCol_Text, redColor);
    ...
    //        ImGui::NewLine(); // spacing
    //        ImGui::SliderFloat("FlashLight Intensity", &Menu::modSettings.headlightIntensity, 0.0f, 5.0f, "%.2f");  
    //        ImGui::NewLine(); // spacing
    ...
    //        ImGui::EndTabItem(); //! End HeadLight
    //    }
    ...
    //        ImGui::NewLine(); // spacing
    //        ImGui::Text("Here you can set the Field Of View (FOV) for each weapon which has a aim down sight (ADS) view or scope.");
    //         ImGui::Text("You can also set the mouse sensitivity multiplier, the lower it is, the slower the mouse will move in ads/scope view");
    //        ImGui::NewLine(); // spacing
    ...
    //        ImGui::SliderFloat("##HandgunSensMultiplier", &Menu::modSettings.handgunAdsFovSensMultiplier, minSensMultiplier, maxSensMultiplier);
    //        ImGui::NewLine(); // spacing
    //        ImGui::NewLine(); // spacing
    ...
    //     if (ImGui::BeginTabItem("Hud And Inputs")) {

    //         ImGui::Checkbox("ADS Key Toggle (WIP)", &Menu::modSettings.isAdsToggle);
    ...
    //        ImGui::Checkbox("Disable Game Crosshair", &Menu::modSettings.isDisableGameCrosshair);
    //        // Custom crosshair settings
    //        //static bool customCrosshair = ModSettings::isCustomCrosshairEnabled();
    //        ImGui::Checkbox("Custom Crosshair", &Menu::modSettings.isCustomCrosshair);
    //        //ModSettings::setIsCustomCrosshairEnabled(customCrosshair);

    //        if (Menu::modSettings.isCustomCrosshair) {
    //          
    //            //static ImVec4 crosshairColor = ImVec4(1.0f, 1.0f, 1.0f, 1.0f); // white
    ...
    //            ImGui::ColorEdit3("Enemy Indicator Color", (float*)&Menu::modSettings.customCrosshairTargetColor);
    ...
    //            //ImGui::Text("Custom Crosshair Size");
    ...
    //            //if (ImGui::Button("-")) {
    //            //Menu::modSettings.customCrosshairSize -= crosshairSizeIncrement;
    //            //Menu::modSettings.customCrosshairSize = std::max(Menu::modSettings.customCrosshairSize, crosshairSizeMin); // Ensure the value doesn't go below the minimum
    //            //}
    //            //ImGui::SameLine();

    //            //if (ImGui::Button("+")) {
    //            //   Menu::modSettings.customCrosshairSize += crosshairSizeIncrement;
    //            //    Menu::modSettings.customCrosshairSize = std::min(Menu::modSettings.customCrosshairSize, crosshairSizeMax); // Ensure the value doesn't exceed the maximum
    //            //}

    //            //ImGui::SameLine();
    //            //ImGui::Text("\tCustom Dot Crosshair Size");
    //         
    //            //int thicknessIncrement = 1;
    //            //int thicknessMin = 1;
    //            //int thicknessMax = 5;
    ...
    //            //if (ImGui::Button("-")) {
    //            //Menu::modSettings.customCrosshairOutlineThickness -= thicknessIncrement;
    //            //Menu::modSettings.customCrosshairOutlineThickness = std::max(Menu::modSettings.customCrosshairOutlineThickness, thicknessMin); 
    //            //}
    ...
    //            //if (ImGui::Button("+")) {
    //            //    Menu::modSettings.customCrosshairOutlineThickness += thicknessIncrement;
    //            //   Menu::modSettings.customCrosshairOutlineThickness = std::min(Menu::modSettings.customCrosshairOutlineThickness, thicknessMax); 
    //            //}

    //            //ImGui::SameLine();
    //            //ImGui::Text("\tCustom Dot Crosshair Outline Thickness");   



    //            ImGui::NewLine(); //! another to create some space.

    //            // Sliders for HUD offsets and visibility
    //            static float hudOffset = 0.5f;
    //            static float hudVisibility = 0.5f;
    //            ImGui::SliderFloat("HUD Offset", &hudOffset, 0.0f, 1.0f);
    //            ImGui::SliderFloat("HUD Visibility", &hudVisibility, 0.0f, 1.0f);       


    //             // Checkbox for enhanced damage feedback
    //            static bool enhancedDamageFeedback = false;
    //            ImGui::Checkbox("Enhanced Damage Feedback", &enhancedDamageFeedback);
    //           
    //        }            
    ...
    //        ImGui::Checkbox("Graphics Setting 1", &setting1); // Add description as needed
    //        // ... add more settings
    ...
    //        ImGui::Checkbox("Silent Protagonist", &Menu::modSettings.isSilentProtagonist);
    ...
    //        // Checkboxes for accessibility options
    //        static bool disableHeadBob = false;
    //        static bool disableDoubleVision = false;
    //        ImGui::Checkbox("Disable Head Bob", &disableHeadBob);
    //        ImGui::Checkbox("Disable Double Vision", &disableDoubleVision);
    ...
    //        ImGui::NewLine(); //! another to create some space.
    //        ImGui::Checkbox("Log MidnightPlay", &Menu::modSettings.isDebugMidnightPlay);
    //        ImGui::Checkbox("Log Print KeyPropAnim", &Menu::modSettings.isDebugPrintKeyPropAnim);
    //        ImGui::Checkbox("Pause Game On Alt Tab", &Menu::modSettings.debugIsPauseGameOnAltTab);
    ...
    //            ShowTooltip("This is a button");
    //        }

    //        ImGui::SliderFloat("Slider", &value, 0.0f, 1.0f);

    //        if (ImGui::IsItemHovered()) {
    //            ShowTooltip("This is a slider");
    //        }

    //        ImGui::Checkbox("Checkbox", &isChecked);

    //        if (ImGui::IsItemHovered()) {
    //            ShowTooltip("This is a checkbox");
    //        }
    ...
    //ImGui::PopStyleVar(); // pop the style var
}

void ImGui::ShowDemoWindowV2(bool* p_open) {

     IM_ASSERT(ImGui::GetCurrentContext() != NULL && "Missing dear imgui context. Refer to examples app!");

     static bool b_show = false;
    static float b_float = 1.0f;

	ImGui::Begin("Wolf 2 Debug:", &b_show);
    //ImGui::Text("hudStateFlags: %d",  Debug::gethudStateFlagsInt());
   /* if (ImGui::Button("Save"))
        MySaveFunction();*/
    //ImGui::InputText("string", buf, IM_ARRAYSIZE(buf));
    //ImGui::SliderFloat("float", &b_float, 0.0f, 5.0f);
    ImGui::End();
}
...
void ImGui::ShowDemoWindow_Orig(bool* p_open)
{
    ...
    if (ImGui::CollapsingHeader("Inputs & Focus"))
    {
        ...
        if (ImGui::TreeNode("Mouse Cursors"))
        {
            ...
            ImGui::SameLine(); HelpMarker(
                ...
                "otherwise your backend needs to handleChange it.");
...
void ImGui::ShowDemoWindowV2(bool*) {}
void ImGui::ShowUserGuide() {}
